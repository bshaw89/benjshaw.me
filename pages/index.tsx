...
export default function Home() {
  return (
    <>
      <Head>
        <title>Ben Shaw | Dear Racoon Logic</title>
          ...
          <div className={styles.column}>
            <div className={styles.divider}>
              ...
              <div className={styles.details}>
                <p>Hey <span className={styles.racoon}>Racoon Logic</span>, I&apos;m Ben.</p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>I love building <span className={styles.racoon}>worlds</span>, especially with amazing and passionate people.</p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>So I want to help you build incredible worlds using <span className={styles.racoon}>Unity</span> and <span className={styles.racoon}>C#</span>. <span className={styles.faded}>And any other cool tools you&apos;re using to make cool games like Savage Planet.</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>I&apos;ve been a full time <span className={styles.racoon}>coder for 3 years</span>, working in <span className={styles.racoon}>C#</span>, <span className={styles.racoon}>DevOps</span>, and <span className={styles.racoon}>Git</span>.<span className={styles.faded}> ASP.NET, JavaScript, node.js, MVC, TypeScript, React, Next.js, HTML, CSS ...</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
            ...
            <div className={styles.divider}>
              ...
              <div className={styles.details}>
                <p>I even did some scripting in <span className={styles.racoon}>Lua</span> for a D&D campaign I ran for 2 years using Tabletop Simulator. That was rough. <span className={styles.faded}>(But my players really appreciated it. Probably.)</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>Before coding, I spent a lot of my time as an <span className={styles.racoon}>opera singer</span>. <span className={styles.faded}>I love collaborating, performing, and being on stage.</span></p>
            ...
            <div className={styles.divider}>
              ...
              <div className={styles.details}>
                <p>I also love <span className={styles.racoon}>making music</span>. I produced an album of original music during Covid. <span className={styles.faded}>(You can check me out as <span className={styles.racoon}>Ben Eris</span> on <span className={styles.racoon}>Spotify</span>)</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>I&apos;m currently working on a <span className={styles.racoon}>coding+music</span> project combining elements of <span className={styles.racoon}>generative music</span>, sound design, and game design using <span className={styles.racoon}>Unity</span>.</p>
              </div>
            </div>
      ...
      <div className={styles.bleedWrap}>
          ...
          <p className={styles.writing10}>SO, Racoon Logic...</p>
          </div>
      </div>
      <footer>
