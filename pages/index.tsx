...
export default function Home() {
  return (
    <>
      <Head>
        <title>Ben Shaw | Dear ManaVoid</title>
          ...
          <div className={styles.column}>
            <div className={styles.divider}>
              ...
              <div className={styles.details}>
                <p>Hey <span className={styles.manavoid}>ManaVoid</span>, I&apos;m Ben.</p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>I love building <span className={styles.manavoid}>worlds</span>, especially with amazing and passionate people.</p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>So I want to help you build incredible worlds using <span className={styles.manavoid}>Unity</span> and <span className={styles.manavoid}>C#</span>. <span className={styles.faded}>And any other cool tools you&apos;re using to make Roots of Yggdrasil and Checkmate Showdown.</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>I&apos;ve been a full time <span className={styles.manavoid}>coder for 3 years</span>, working in <span className={styles.manavoid}>C#</span>, <span className={styles.manavoid}>DevOps</span>, and <span className={styles.manavoid}>Git</span>.<span className={styles.faded}> ASP.NET, JavaScript, node.js, MVC, TypeScript, React, Next.js, HTML, CSS ...</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
            ...
            <div className={styles.divider}>
              ...
              <div className={styles.details}>
                <p>I even did some scripting in <span className={styles.manavoid}>Lua</span> for a D&D campaign I ran for 2 years using Tabletop Simulator. That was rough. <span className={styles.faded}>(But my players really appreciated it. Probably.)</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>Before coding, I spent a lot of my time as an <span className={styles.manavoid}>opera singer</span>. <span className={styles.faded}>I love collaborating, performing, and being on stage.</span></p>
            ...
            <div className={styles.divider}>
              ...
              <div className={styles.details}>
                <p>I also love <span className={styles.manavoid}>making music</span>. I produced an album of original music during Covid. <span className={styles.faded}>(You can check me out as <span className={styles.manavoid}>Ben Eris</span> on <span className={styles.manavoid}>Spotify</span>)</span></p>
              </div>
            </div>
            <div className={styles.divider}>
              <div className={styles.pageLeft}>
              ...
              <div className={styles.details}>
                <p>I&apos;m currently working on a <span className={styles.manavoid}>coding+music</span> project combining elements of <span className={styles.manavoid}>generative music</span>, sound design, and game design using <span className={styles.manavoid}>Unity</span>.</p>
              </div>
            </div>
      ...
      <div className={styles.bleedWrap}>
          ...
          <p className={styles.writing10}>SO, ManaVoid...</p>
          </div>
      </div>
      <footer>
